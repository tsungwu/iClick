...
.sharpeIneq <- function(datx, home,removal,index,Rf=0,MAR=0,Rb,splitDate){
  ...
  if(index=="StdDev"){
    left=JFE::SharpeRatio(foreign,Rf,FUN="StdDev")
    right=JFE::SharpeRatio(homeAsset,Rf,FUN="StdDev")
  }
  else if(index=="VaR"){
    left=JFE::SharpeRatio(foreign,Rf,FUN="VaR")
    right=JFE::SharpeRatio(homeAsset,Rf,FUN="VaR")
  }
  else if(index=="ES"){
    left=JFE::SharpeRatio(foreign,Rf,FUN="ES")
    right=JFE::SharpeRatio(homeAsset,Rf,FUN="ES")
  }
  else {
  ...
  Performance=JFE::SharpeRatio(portfolioReturns,Rf,FUN=index)
  ...
  Title=paste("Performance by ", index)
    ...
    print(JFE::table.AnnualizedReturns(xts::as.xts(portfolioReturns)))
